...
- Stage: Draft plan.
- Depends on `development/docs/docs-refresh.md` content and playground embed wiring.
- Next: execute the plan to update docs pages, examples, and MkDocs navigation.
...
## Documentation architecture (targeting `development/docs/docs-refresh.md` as the drafting ground)
