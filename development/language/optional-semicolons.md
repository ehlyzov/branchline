...
- Parser tests assert that block statements, expression statements, and top-level declarations parse without trailing semicolons, confirming newline handling across the surface.【F:interpreter/src/jvmTest/kotlin/v2/ParserTests.kt†L71-L118】
